...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void insertData(String name, String description, byte[] image, String location, String state, String mapslink, Float rating, String nearby) {
        ...
        statement.bindString(8,nearby);

        statement.executeInsert();
    }

    public void updateData(String name, String description, byte[] image, String location, String state, String mapslink, Float rating, String nearby, String id) {
        SQLiteDatabase database = getWritableDatabase();

        String sql = "UPDATE PLACE SET name=?, description=?, image=?, location=?, state=?, mapslink=?, rating=?, nearby=? WHERE id=?";
        SQLiteStatement statement = database.compileStatement(sql);
